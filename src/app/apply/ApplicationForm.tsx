...
function Select({
  ...
  return (
    <select
      name={name}
      defaultValue=""
      className={`w-full min-w-0 border rounded-[7px] bg-white text-[#465875] text-[12px] pl-[37px] pr-3 h-[40px] focus:outline-none focus:ring-2 transition-colors cursor-pointer ${error
...
export default function ApplicationForm({
  ...
  const inputClass = (hasError?: boolean) =>
    `w-full min-w-0 border rounded-[7px] bg-white text-[#465875] text-[12px] pl-[37px] pr-3 h-[40px] focus:outline-none focus:ring-2 placeholder:text-[#8ea3be] transition-colors ${hasError
      ? "border-red-500 bg-red-50/40 focus:ring-red-500"
      : "border-[#e1e9f2] focus:ring-[#2865ef]"
    }`;

  const tableInputClass = (hasError?: boolean) =>
    `w-full min-w-0 border rounded-[7px] bg-white text-[#465875] text-[11px] px-2.5 h-[36px] focus:outline-none focus:ring-2 placeholder:text-[#8ea3be] transition-colors ${hasError
      ? "border-red-500 bg-red-50/40 focus:ring-red-500"
      : "border-[#e1e9f2] focus:ring-[#2865ef]"
    }`;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-9">
              ...
              <Field label="Course" icon={<BookOpen />} error={errors.course}>
                {defaultCourse ? (
                  ...
                  <select
                    name="course"
                    defaultValue=""
                    className={`w-full min-w-0 border rounded-[7px] bg-white text-[#465875] text-[12px] pl-[37px] pr-3 h-[40px] focus:outline-none focus:ring-2 transition-colors cursor-pointer ${errors.course
                      ? "border-red-500 bg-red-50/40 focus:ring-red-500"
                      : "border-[#e1e9f2] focus:ring-[#2865ef]"
                      }`}
              ...
              <Field label="Postal Address" icon={<MapPin />} wide error={errors.address} isTextarea>
                <textarea
                  ...
                  rows={2}
                  maxLength={500}
                  className={`w-full min-w-0 border rounded-[7px] bg-white text-[#465875] text-[12px] pl-[37px] pr-3 h-[60px] py-2.5 resize-y focus:outline-none focus:ring-2 placeholder:text-[#8ea3be] transition-colors ${errors.address
                    ? "border-red-500 bg-red-50/40 focus:ring-red-500"
                    : "border-[#e1e9f2] focus:ring-[#2865ef]"
                    }`}
              ...
              <Field label="Profile Image (jpg only)" icon={<ImageSquare />} error={errors.profileImage}>
                <input
                  ...
                  className={`w-full min-w-0 border rounded-[7px] bg-white text-[#465875] text-[10px] pl-[34px] pr-2 py-2 focus:outline-none focus:ring-2 transition-colors file:mr-2.5 file:py-1 file:px-2.5 file:border file:border-[#dde6f0] file:rounded file:bg-[#f7f9fc] file:text-[#33465e] file:text-[11px] file:cursor-pointer ${errors.profileImage
                    ? "border-red-500 bg-red-50/40 focus:ring-red-500"
                    : "border-[#e1e9f2] focus:ring-[#2865ef]"
                    }`}
                    ...
                    <tr key={level}>
                      ...
                      <td>
                        <select
                          ...
                          defaultValue=""
                          className={`w-full min-w-0 border rounded-[7px] bg-white text-[#465875] text-[11px] px-2 h-[36px] focus:outline-none focus:ring-2 cursor-pointer ${errors.classXMedium
                            ? "border-red-500 bg-red-50/40 focus:ring-red-500"
                            : "border-[#e1e9f2] focus:ring-[#2865ef]"
                            }`}
                      ...
                      <td>
                        <input
                          ...
                          className={`w-full min-w-0 border rounded-[7px] bg-white text-[#465875] text-[9px] p-1.5 focus:outline-none focus:ring-2 file:mr-1.5 file:py-0.5 file:px-1.5 file:border file:border-[#dde6f0] file:rounded file:bg-[#f7f9fc] file:text-[#33465e] file:text-[10px] ${errors.classXCertificate
                            ? "border-red-500 bg-red-50/40 focus:ring-red-500"
                            : "border-[#e1e9f2] focus:ring-[#2865ef]"
                            }`}
