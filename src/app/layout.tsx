...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "best college in hyderabad",
    "Top Junior College in Telangana",
    ...
    "Best Junior College in Hyderabad",
    "Top Intermediate College",
    "Science and Commerce College",
    "Intermediate Admissions",
    "Student-centric learning",
    "NEET Coaching Hyderabad",
    "JEE Mains Coaching Hyderabad",
